...
class SalesBridgeSettingsTest extends TestCase
{
    ...
    public function test_it_saves_and_returns_the_seven_sales_bridge_accounts(): void
    {
        ...
        $discount = Account::create(['code' => '5007', 'name' => 'خصم مسموح به', 'type' => 'expense', 'is_active' => true]);
        ...
        $this->actingAs($user)->putJson('/api/settings', [
            ...
            ->assertJsonPath('sales_discount_account_id', $discount->id);
    ...
    public function test_they_default_to_null_when_unset(): void
    {
        ...
        $this->actingAs($user)->getJson('/api/settings')
            ...
            ->assertJsonPath('sales_discount_account_id', null);
    }
